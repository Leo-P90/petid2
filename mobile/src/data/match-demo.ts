...
export const matchDemo: readonly Candidate[] = [
  ...
  { id: 'match-ada', photoPosition: { x: 18, y: 50 }, species: 'Kedi', name: 'Ada', age: '3 yaş', breed: 'Ankara Kedisi', gender: 'Dişi', distance: '1.2 km', bio: 'Oyun arkadaşı arıyor · Kurgu demo profil.', compatibility: 88, photo: photo('1518791841217-8f162f1e1131'), mutual: true, opener: 'Demo: Mia ile tanışmak güzel!', reply: 'Demo otomatik yanıt: Patili bir merhaba! 🐾' },
  { id: 'match-max', species: 'Köpek', name: 'Max', age: '3 yaş', breed: 'Golden Retriever', gender: 'Erkek', distance: '3.3 km', bio: 'Park yürüyüşlerini seviyor · Kurgu demo profil.', compatibility: 95, photo: 'asset:match-golden-r3', mutual: true, opener: 'Demo: Atlas ile yürüyüş hayal edelim!', reply: 'Demo otomatik yanıt: Parkta oyun fikri harika.' },
