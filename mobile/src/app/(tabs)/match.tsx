...
function Portrait({ candidate, small = false }: { candidate: Candidate; small?: boolean }) {
  ...
  return <View style={{ height: small ? 48 : 300, width: small ? 48 : '100%', borderRadius: 24, overflow: 'hidden', backgroundColor: colors.greenSoft, justifyContent: 'center', alignItems: 'center' }}>
